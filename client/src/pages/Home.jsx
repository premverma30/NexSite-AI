...
import { Coins,ArrowRight,Play,Code2,Smartphone,Sparkles,RotateCcw,Download,Shield,Pencil,Zap,Rocket,} from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "Clean, semantic HTML and CSS with proper structure, accessibility, and scalable architecture.",
      tag: "No boilerplate",
      tagColor: "purple",
    },
    {
      ...
      desc: "Every site looks perfect on any screen — mobile, tablet, or desktop — from the first generation.",
      tag: "Mobile-first",
      tagColor: "blue",
    },
    {
      ...
      desc: "Scroll reveals, hover states, and micro-interactions are built in automatically.",
      tag: "60fps",
      tagColor: "green",
    },
    {
      ...
      desc: "Ask NexSite to change the hero, tweak colors, or restructure any section. It understands context.",
      tag: "Conversational",
      tagColor: "purple",
    },
    {
      ...
      desc: "Download your site as a clean HTML file or deploy directly to a custom URL in seconds.",
      tag: "Deploy instantly",
      tagColor: "blue",
    },
    {
      icon: <Shield size={18} />,
      title: "Version history",
      desc: "Every generation is saved. Jump back to any previous version of your site with a single click.",
      tag: "Auto-saved",
      tagColor: "green",
    },
  ];
    ...
    <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-5 z-10 text-center">
              ...
              <p className="text-white/60 text-sm max-w-md -mt-1">
                Launch, iterate, and scale your ideas with a modern platform
              ...
              <div className="flex gap-4 mt-1">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className={`
                    relative w-28 h-16 rounded-xl border backdrop-blur-md transition-all duration-300
                    ${
                      i === 1
                        ? "bg-gradient-to-br from-purple-500/20 to-blue-500/20 border-purple-400/30 scale-105 shadow-lg shadow-purple-500/20"
                ...
                `}
                  >
                    {/* subtle inner glow */}
                    {i === 1 && (
                      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500/10 to-blue-500/10 blur-md" />
                    )}

                    <div className="relative w-full h-full flex items-center justify-center text-[10px] text-white/40">
                      Preview
                    </div>
                  </div>
                ))}
              ...
              {/* CTA Buttons (moved UP slightly) */}
              <div className="flex gap-3 mt-2">
                <button className="px-6 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm font-semibold shadow-md hover:scale-105 hover:shadow-purple-500/30 transition">
                  Get Started →
                </button>

                <button className="px-6 py-2 rounded-lg bg-white/5 border border-white/10 text-white/70 text-sm font-semibold hover:bg-white/10 transition">
                  Live Demo
                </button>
              </div>
            </div>
            ...
            {[
              {
                ...
                desc: "Type what you want — a portfolio, SaaS page, or product showcase. Be as brief or detailed as you like.",
              },
              {
                step: "02",
                icon: <Zap size={18} />,
                title: "AI generates instantly",
                desc: "NexSite crafts clean, semantic HTML with modern animations, full responsiveness, and polished hierarchy.",
              },
              {
                step: "03",
                icon: <Rocket size={18} />,
                title: "Edit and publish",
                desc: "Tweak in the live editor, iterate with follow-up prompts, then export or deploy with one click.",
              },
            ].map((s, i) => (
              <div
                key={i}
                className="p-8 hover:bg-white/[0.02] transition group"
              >
                <p className="text-xs font-semibold text-purple-400 tracking-widest uppercase mb-5">
                  Step {s.step}
                </p>
        ...
        >
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <p className="text-zinc-500 text-sm max-w-xs leading-relaxed">
              Production-grade output with real code, real animations, and real
              responsiveness — not mockups.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {features.map((f, i) => (
              ...
              >
                ...
                <span
                  className={`text-xs px-2.5 py-1 rounded-md ${tagColors[f.tagColor]}`}
                >
                  {f.tag}
                </span>
              </motion.div>
            ...
            {highlights.map((h, i) => (
              ...
              >
                ...
                <p className="text-sm text-zinc-400 leading-relaxed">
                  NexSite.ai builds real websites — clean code, animations,
              ...
              >
                <div className="h-44 bg-black relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0e0e12]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-end p-3">
                    <span className="text-xs text-white bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full border border-white/15">
                      Open →
                    </span>
                  </div>
                </div>
      ...
      <section className="relative z-10 max-w-3xl mx-auto px-6 mb-32">
        ...
        >
          ...
          <div
            className="absolute top-[-80px] left-1/2 -translate-x-1/2 w-72 h-72 rounded-full pointer-events-none"
            style={{
              background:
                "radial-gradient(circle, rgba(168,85,247,0.1) 0%, transparent 70%)",
            }}
          ...
          <p className="text-zinc-400 mb-10 leading-relaxed relative z-10">
            Join thousands of creators, founders, and developers
      ...
      <footer className="relative z-10 border-t border-white/10 py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-zinc-600">
            Copyright &copy; {new Date().getFullYear()} NexSite.ai | All rights
            reserved
          </div>
        </div>
      </footer>
